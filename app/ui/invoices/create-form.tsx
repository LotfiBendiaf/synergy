  ...
  return (
    <form action={dispatch}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        {/* Invoice Remaining */}
        <div className="mb-4">
          <label htmlFor="remaining" className="mb-2 block text-sm font-medium">
            Remaining amount
          </label>
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                placeholder="Enter USD amount"
                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                aria-describedby="remaining-error"
              />
              <CurrencyDollarIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
            </div>
          </div>
          <div id="remaining-error" aria-live="polite" aria-atomic="true">
            {state.errors?.remaining &&
              state.errors.remaining.map((error: string) => (
                <p className="mt-2 text-sm text-red-500" key={error}>
                  {error}
                </p>
              ))}
            ...
            <div className="flex gap-4">
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="paid"
                  className="h-4 w-4 border-gray-300 bg-gray-100 text-gray-600 focus:ring-2 focus:ring-blue-950 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-blue-950 dark:focus:ring-gray-600"
                  aria-describedby="status-error"
                />
                <label
                  htmlFor="paid"
